							...
							<div className="cards-list">
								...
								<div className="card-item-small">
									<div>
										...
										<strong>Jyaden Kim</strong>
									</div>
									<ReadMore
										text="
										Jayden has worked as a backend developer,but now he is trying to extend his ability to frontend area, especially using React JS. Apart from that he would like to support OpenLaw NZ project.
										"
									/>
								</div>
							</div>
